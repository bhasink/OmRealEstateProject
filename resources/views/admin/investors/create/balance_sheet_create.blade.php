    ...
    <div class="" id="app">
        ...
        <div class="row">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Investors <small>Balance Sheet Create</small></h2>
                    ...
                    <div class="x_content">
                        ...
                        {!! Form::open(array('action'=>'Admin\AdminInvestorController@balance_sheet_create_save','method'=>'post','id'=>'contact_formm','enctype' => 'multipart/form-data')) !!}
