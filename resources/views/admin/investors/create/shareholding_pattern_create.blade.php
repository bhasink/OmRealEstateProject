    ...
    <div class="" id="app">
        ...
        <div class="row">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Investors <small>Shareholding Pattern Create</small></h2>
                    ...
                    <div class="x_content">
                        ...
                        {!! Form::open(array('action'=>'Admin\AdminInvestorController@shareholding_pattern_create','method'=>'post','id'=>'contact_formm','enctype' => 'multipart/form-data')) !!}
