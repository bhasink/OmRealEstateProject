            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        {!! Form::open(array('action'=>'Admin\AdminInvestorController@committees_of_board_of_directors_create_save','method'=>'post','id'=>'contact_formm','enctype' => 'multipart/form-data')) !!}
