        ...
        <div class="row">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="flash-message">
                    ...
                    @if(Session::has('alert-stakeholder-information-created'))
                        {{--<script> alert('Meta Sucessfully Created.')</script>--}}
                        <div class="alert alert-success" role="alert">
                            Stakeholder information sucessfully created.
                        </div>
                    @endif
                    ...
                    @if(Session::has('alert-stakeholder-information-created_u'))
                        {{--<script> alert('Meta Updated Successfully.')</script>--}}
                        <div class="alert alert-success" role="alert">
                            Stakeholder information updated sucessfully.
                        </div>
                    @endif
                    ...
                    @if(Session::has('alert-stakeholder-created_d'))
                        <div class="alert alert-success" role="alert">
                            Stakeholder information deleted sucessfully.
                        </div>
                ...
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Investor  <small>Stakeholder Information</small></h2>

                        <div style="float: right;">
                            <a href="{{url('/omaxeadmin/investor/list/stakeholder-information/create')}}" class="btn btn-success" style="background-color: #28a745; border-color: #28a745;" href=""><i class="fas fa-plus-square"></i>
                                Create Investor Stakeholder Information</a>
                        </div>
                            ...
                            @if(isset($get_investor_data_list))
                                ...
                                @foreach($get_investor_data_list as $key=>$get_investor_data_list)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="/omaxeadmin/investor/list/stakeholder-information/edit/{{$get_investor_data_list->id}}" class="btn btn-success">Edit</a>
                                        </td>

                                        <td>
                                            <a href="/omaxeadmin/investor/list/stakeholder-information/delete/{{$get_investor_data_list->id}}" onclick="return confirm('Are you sure?');" class="btn btn-danger">Delete</a>
                                        </td>
