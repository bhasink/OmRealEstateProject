        ...
        <div class="row">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="flash-message">
                    ...
                    @if(Session::has('alert-csr-event-update'))
                        {{--<script> alert('Meta Updated Successfully.')</script>--}}
                        <div class="alert alert-success" role="alert">
                            CSR Event updated sucessfully.
                        </div>
                    @endif
                    ...
                    @if(Session::has('alert-csr-report-event_d'))
                        <div class="alert alert-success" role="alert">
                            CSR Event deleted sucessfully.
                        </div>
                ...
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Investor  <small>CSR Event List</small></h2>

                        <div style="float: right;">
                            <a href="{{url('/omaxeadmin/investor/list/csr-event/create')}}" class="btn btn-success" style="background-color: #28a745; border-color: #28a745;" href=""><i class="fas fa-plus-square"></i>
                                Create CSR Event Report</a>
                        </div>
...
{{--                                        <td>{{$get_investor_data_list->report_qtr}}</td>--}}
                                        ...
                                        <td>
                                            <a href="/omaxeadmin/investor/list/csr-event/edit/{{$get_investor_data_list->id}}" class="btn btn-success">Edit</a>
                                        </td>

                                        <td>
                                            <a href="/omaxeadmin/investor/list/csr-event/delete/{{$get_investor_data_list->id}}" onclick="return confirm('Are you sure?');" class="btn btn-danger">Delete</a>
                                        </td>
