        ...
        <div class="row">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="flash-message">
                    ...
                    @if(Session::has('alert-resignation-create'))
                        {{--<script> alert('Meta Sucessfully Created.')</script>--}}
                        <div class="alert alert-success" role="alert">
                            Resignation Letter sucessfully created.
                        </div>
                    @endif
                    ...
                    @if(Session::has('alert-resignation-update'))
                        {{--<script> alert('Meta Updated Successfully.')</script>--}}
                        <div class="alert alert-success" role="alert">
                            Resignation Letter updated sucessfully.
                        </div>
                    @endif
                    ...
                    @if(Session::has('alert-resignation-created_d'))
                        <div class="alert alert-success" role="alert">
                            Resignation Letter deleted sucessfully.
                        </div>
                ...
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Investor  <small>Resignation Letters</small></h2>

                        <div style="float: right;">
                            <a href="{{url('/omaxeadmin/investor/list/resignation-letters/create')}}" class="btn btn-success" style="background-color: #28a745; border-color: #28a745;" href=""><i class="fas fa-plus-square"></i>
                                Create Resignation Letters</a>
                        </div>
                            ...
                            @if(isset($get_investor_data_list))
                                ...
                                @foreach($get_investor_data_list as $key=>$get_investor_data_list)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="/omaxeadmin/investor/list/resignation-letters/edit/{{$get_investor_data_list->id}}" class="btn btn-success">Edit</a>
                                        </td>

                                        <td>
                                            <a href="/omaxeadmin/investor/list/resignation-letters/delete/{{$get_investor_data_list->id}}" onclick="return confirm('Are you sure?');" class="btn btn-danger">Delete</a>
                                        </td>
