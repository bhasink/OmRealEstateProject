    ...
    <div class="" id="app">
        ...
        <div class="row">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Investors <small>Notice and Information Edit</small></h2>
                    ...
                    <div class="x_content">
                        ...
                        {!! Form::open(array('action'=>'Admin\AdminInvestorController@notice_and_information_edit_save','method'=>'post','id'=>'contact_formm','enctype' => 'multipart/form-data')) !!}
...
"></i></span>
                                                ...
                                                <select required class="form-control" name="investor_report_year" id="">
                                                    ...
                                                    <option value="2019-20" {{$get_investor_data->report_year=='2019-20'?'selected':''}}>2019-20</option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12 inputGroupContainer">
                                            <div class="input-group">
                                                <span class="input-group-addon"><i class="glyphicon glyphicon-align-justify
"></i></span>
                                                <a target="_blank" style="margin: 10px;" href="/investors/pdf/{{$get_investor_data->inv_pdf}}" class="btn btn-primary">Investor Pdf</a>
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-8 mb-3">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <a href="{{url('/omaxeadmin/investor/list/notice-and-information')}}" class="btn btn-primary"  style="padding: 10px;  margin-top: 20px;">Go Back</a>
