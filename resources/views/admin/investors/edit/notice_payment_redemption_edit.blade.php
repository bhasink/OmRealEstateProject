    ...
    <div class="" id="app">
        ...
        <div class="row">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Investors <small>Notice And Payment Redemption</small></h2>
                    ...
                    <div class="x_content">
                        ...
                        {!! Form::open(array('action'=>'Admin\AdminInvestorController@notice_payment_redemption_edit_save','method'=>'post','id'=>'contact_formm','enctype' => 'multipart/form-data')) !!}
...
"></i></span>
                                            ...
                                            <select required class="form-control" name="investor_report_year" id="">
                                                ...
                                                <option value="Other Documents" {{$get_investor_data->report_year=='Other Documents'?'selected':''}}>Other Documents</option>
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-8 mb-3">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <a href="{{url('/omaxeadmin/investor/list/notice-payment-redemption')}}" class="btn btn-primary"  style="padding: 10px;  margin-top: 20px;">Go Back</a>
