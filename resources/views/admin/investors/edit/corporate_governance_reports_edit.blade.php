    ...
    <div class="" id="app">
        ...
        <div class="row">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Investors <small>Corporate Governance Report Edit</small></h2>
                    ...
                    <div class="x_content">
                        ...
                        {!! Form::open(array('action'=>'Admin\AdminInvestorController@corporate_governance_reports_edit_save','method'=>'post','id'=>'contact_formm','enctype' => 'multipart/form-data')) !!}
...
"></i></span>
                        ...
                        <div class="form-row">
                            <div class="col-md-8 mb-3">
                                <div class="form-group">
                                    <label class="col-md-12 control-label"><b>Investor Report QTR:</b></label>
                                    <div class="col-md-12 inputGroupContainer">
                                        <div class="input-group">
                                                <span class="input-group-addon"><i class="glyphicon glyphicon-align-justify
"></i></span>
                                            ...
                                            <select required class="form-control" name="investor_report_qtr" id="">
                                                <option value="">--Select Report QTR--</option>
                                                <option {{$get_investor_data->report_qtr=='Q1'?'selected':''}} value="Q1">Q1</option>
                                                <option {{$get_investor_data->report_qtr=='Q2'?'selected':''}} value="Q2">Q2</option>
                                                <option {{$get_investor_data->report_qtr=='Q3'?'selected':''}} value="Q3">Q3</option>
                                                <option {{$get_investor_data->report_qtr=='Q4'?'selected':''}} value="Q4">Q4</option>
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-8 mb-3">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <a href="{{url('/omaxeadmin/investor/list/corporate-governance-reports')}}" class="btn btn-primary"  style="padding: 10px;  margin-top: 20px;">Go Back</a>
