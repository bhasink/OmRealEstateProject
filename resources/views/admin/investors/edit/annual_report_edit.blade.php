    ...
    <div class="" id="app">
        ...
        <div class="row">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Investors <small>Annual Report Edit</small></h2>
                    ...
                    <div class="x_content">
                        ...
                        {!! Form::open(array('action'=>'Admin\AdminInvestorController@annual_report_edit_save','method'=>'post','id'=>'contact_formm','enctype' => 'multipart/form-data')) !!}
...
"></i></span>
                        ...
                        <div class="form-row">
                            <div class="col-md-8 mb-3">
                                <div class="form-group">
                                    <label class="col-md-12 control-label"><b>Upload Investor Image:</b></label>
                                    <div class="col-md-12 inputGroupContainer">
                                        <div class="input-group">
                                                <span class="input-group-addon"><i class="glyphicon glyphicon-align-justify
"></i></span>
                                            ...
                                            <img style="margin: 10px;" width="100" height="100" src="/investors/images/annual_reports/{{$get_investor_data->investor_image}}" alt="">
                                            <input class="form-control"  type="file" name="investor_image" value="{{$get_investor_data->investor_image}}">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-8 mb-3">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <a href="{{url('/omaxeadmin/investor/list/annual-report')}}" class="btn btn-primary"  style="padding: 10px;  margin-top: 20px;">Go Back</a>
