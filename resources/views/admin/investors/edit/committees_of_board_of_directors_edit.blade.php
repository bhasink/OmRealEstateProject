    ...
    <div class="" id="app">
        ...
        <div class="row">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Investors <small>Committees of board of director</small></h2>
                    ...
                    <div class="x_content">
                        ...
                        {!! Form::open(array('action'=>'Admin\AdminInvestorController@committees_board_directors_edit_save','method'=>'post','id'=>'contact_formm','enctype' => 'multipart/form-data')) !!}
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-8 mb-3">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <a href="{{url('/omaxeadmin/investor/list/committees-of-board-of-directors')}}" class="btn btn-primary"  style="padding: 10px;  margin-top: 20px;">Go Back</a>
