        ...
        <div class="row">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="flash-message">
                    ...
                    @if(Session::has('alert-csr-event-created'))
                        {{--<script> alert('Meta Sucessfully Created.')</script>--}}
                        <div class="alert alert-success" role="alert">
                            CSR Policy sucessfully created.
                        </div>
                    @endif
                    ...
                    @if(Session::has('alert-csr-event-created_u'))
                        {{--<script> alert('Meta Updated Successfully.')</script>--}}
                        <div class="alert alert-success" role="alert">
                            CSR Policy updated sucessfully.
                        </div>
                    @endif
                ...
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Investor  <small>CSR Policy List</small></h2>

                        <div style="float: right;">
                            <a href="{{url('/omaxeadmin/investor/list/csr-policy/create')}}" class="btn btn-success" style="background-color: #28a745; border-color: #28a745;" href=""><i class="fas fa-plus-square"></i>
                                Create Investor CSR Policy</a>
                        </div>
...
{{--                                        <td>{{$get_investor_data_list->report_year}}</td>--}}
                                        ...
                                        <td>
                                            <a href="/omaxeadmin/investor/list/csr-policy/edit/{{$get_investor_data_list->id}}" class="btn btn-success">Edit</a>
                                        </td>

                                        <td>
                                            <a href="/omaxeadmin/investor/list/csr-policy/delete/{{$get_investor_data_list->id}}" onclick="return confirm('Are you sure?');" class="btn btn-danger">Delete</a>
                                        </td>
