        ...
        <div class="row">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="flash-message">
                    ...
                    @if(Session::has('alert-governance-create'))
                        {{--<script> alert('Meta Sucessfully Created.')</script>--}}
                        <div class="alert alert-success" role="alert">
                            Corporate Governance sucessfully created.
                        </div>
                    @endif
                    ...
                    @if(Session::has('alert-governance-report-update'))
                        {{--<script> alert('Meta Updated Successfully.')</script>--}}
                        <div class="alert alert-success" role="alert">
                            Corporate Governance updated sucessfully.
                        </div>
                    @endif
                    ...
                    @if(Session::has('alert-governance-report-delete'))
                        <div class="alert alert-success" role="alert">
                            Corporate Governance deleted sucessfully.
                        </div>
                ...
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Investor  <small>Corporate Governance</small></h2>

                        <div style="float: right;">
                            <a href="{{url('/omaxeadmin/investor/list/corporate-governance/create')}}" class="btn btn-success" style="background-color: #28a745; border-color: #28a745;" href=""><i class="fas fa-plus-square"></i>
                                Create Investor Corporate Governance</a>
                        </div>
                            ...
                            @if(isset($get_investor_data_list))
                                ...
                                @foreach($get_investor_data_list as $key=>$get_investor_data_list)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="/omaxeadmin/investor/list/corporate-governance/edit/{{$get_investor_data_list->id}}" class="btn btn-success">Edit</a>
                                        </td>

                                        <td>
                                            <a href="/omaxeadmin/investor/list/corporate-governance/delete/{{$get_investor_data_list->id}}" onclick="return confirm('Are you sure?');" class="btn btn-danger">Delete</a>
                                        </td>
