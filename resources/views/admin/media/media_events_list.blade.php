        ...
        <div class="row">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="flash-message">
                    ...
                    @if(Session::has('alert-media-events-create'))
                        {{--<script> alert('Meta Sucessfully Created.')</script>--}}
                        <div class="alert alert-success" role="alert">
                            Media Events sucessfully created.
                        </div>
                    @endif
                    ...
                    @if(Session::has('alert-media-ad-campaign-update'))
                        ...
                        <div class="alert alert-success" role="alert">
                            Media Events updated sucessfully.
                        </div>
                    @endif
                    ...
                    @if(Session::has('alert-events-delete'))
                        <div class="alert alert-success" role="alert">
                            Media Events deleted sucessfully.
                        </div>
                ...
                <div class="x_panel">
                    <div class="x_title">
                        ...
                        <div style="float: right;">
                            <a href="{{url('/omaxeadmin/media/media-events/create')}}" class="btn btn-success" style="background-color: #28a745; border-color: #28a745;" href=""><i class="fas fa-plus-square"></i>
                                Create Media Events</a>
                        </div>
                            ...
                            @if(isset($get_media_data_list))
                                ...
                                @foreach($get_media_data_list as $key=>$get_media_data_list_data)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="/omaxeadmin/media/events/edit/{{$get_media_data_list_data->id}}" class="btn btn-success">Edit</a>
                                        </td>

                                        <td>
                                            <a href="/omaxeadmin/media/media-events/delete/{{$get_media_data_list_data->id}}" onclick="return confirm('Are you sure?');" class="btn btn-danger">Delete</a>
                                        </td>
