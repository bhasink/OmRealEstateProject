        ...
        <div class="row">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="flash-message">
                    ...
                    @if(Session::has('alert-press-releases-create'))
                        {{--<script> alert('Meta Sucessfully Created.')</script>--}}
                        <div class="alert alert-success" role="alert">
                            Media Press Releases sucessfully created.
                        </div>
                    @endif
                    ...
                    @if(Session::has('alert-media-ad-campaign-update'))
                        ...
                        <div class="alert alert-success" role="alert">
                            Media Press Releases updated sucessfully.
                        </div>
                    @endif
                    ...
                    @if(Session::has('alert-press-releases-delete'))
                        <div class="alert alert-success" role="alert">
                            Media Press Releases deleted sucessfully.
                        </div>
                ...
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Media  <small>Ad Campaign Dashboard</small></h2>

                        <div style="float: right;">
                            <a href="{{url('/omaxeadmin/media/press-releases/create')}}" class="btn btn-success" style="background-color: #28a745; border-color: #28a745;" href=""><i class="fas fa-plus-square"></i>
                                Create Media Press Releases</a>
                        </div>
                            ...
                            @if(isset($get_media_data_list))
                                ...
                                @foreach($get_media_data_list as $key=>$get_media_data_list_data)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="/omaxeadmin/media/press-releases/edit/{{$get_media_data_list_data->id}}" class="btn btn-success">Edit</a>
                                        </td>

                                        <td>
                                            <a href="/omaxeadmin/media/press-releases/delete/{{$get_media_data_list_data->id}}" onclick="return confirm('Are you sure?');" class="btn btn-danger">Delete</a>
                                        </td>
