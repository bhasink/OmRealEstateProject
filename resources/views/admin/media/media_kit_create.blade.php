    ...
    <div class="" id="app">
        ...
        <div class="row">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Media  <small>Media Kit Create</small></h2>

                        <div class="clearfix"></div>
                    </div>
                    <div class="x_content">

                        {!! Form::open(array('action'=>'Admin\AdminMediaController@media_kit_create_save','method'=>'post','id'=>'contact_formm','enctype' => 'multipart/form-data')) !!}
...
"></i></span>
                                                <input required class="form-control"  type="text" name="media_title" >
...
"></i></span>
                                                ...
                                                <input required class="form-control"  type="file" name="media_image" >
...
"></i></span>
                                                ...
                                                <input required class="form-control"  type="file" name="media_pdf" >
