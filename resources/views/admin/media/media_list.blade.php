                            ...
                            @if(isset($get_media_data_list))
                                ...
                                @foreach($get_media_data_list as $key=>$get_media_data_list_data)
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$get_media_data_list_data->created_at==null?'Created By Sociowash':$get_project_data->created_at}}
                                        </td>
                                        <td>
                                            <a href="/omaxeadmin/projects/edit/{{$get_media_data_list_data->id}}" class="btn btn-success">Edit</a>
                                        </td>
                                        <td>
                                            <a href="/omaxeadmin/projects/delete/{{$get_media_data_list_data->id}}" onclick="return confirm('Are you sure?');" class="btn btn-danger">Delete</a>
                                        </td>
