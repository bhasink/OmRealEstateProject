        ...
        <div class="row">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="flash-message">
                    ...
                    @if(Session::has('alert-media-e-coverage-create'))
                        {{--<script> alert('Meta Sucessfully Created.')</script>--}}
                        <div class="alert alert-success" role="alert">
                            Media E-Coverages sucessfully created.
                        </div>
                    @endif
                    ...
                    @if(Session::has('alert-media-e-coverages-update'))
                        {{--<script> alert('Meta Updated Successfully.')</script>--}}
                        <div class="alert alert-success" role="alert">
                            Media E-Coverages updated sucessfully.
                        </div>
                    @endif
                    ...
                    @if(Session::has('alert-e-coverages-delete'))
                        <div class="alert alert-success" role="alert">
                            Media E-Coverages deleted sucessfully.
                        </div>
                ...
                <div class="x_panel">
                    <div class="x_title">
                        ...
                        <div style="float: right;">
                            <a href="{{url('/omaxeadmin/media/e-coverages/create')}}" class="btn btn-success" style="background-color: #28a745; border-color: #28a745;" href=""><i class="fas fa-plus-square"></i>
                                Create Media E-Coverages</a>
                        </div>
                            ...
                            @if(isset($get_media_data_list))
                                ...
                                @foreach($get_media_data_list as $key=>$get_media_data_list_data)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="/omaxeadmin/media/e-coverages/edit/{{$get_media_data_list_data->id}}" class="btn btn-success">Edit</a>
                                        </td>

                                        <td>
                                            <a href="/omaxeadmin/media/e-coverages/delete/{{$get_media_data_list_data->id}}" onclick="return confirm('Are you sure?');" class="btn btn-danger">Delete</a>
                                        </td>
