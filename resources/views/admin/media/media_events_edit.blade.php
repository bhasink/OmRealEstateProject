            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        {!! Form::open(array('action'=>'Admin\AdminMediaController@media_events_edit_save','method'=>'post','id'=>'contact_formm','enctype' => 'multipart/form-data')) !!}
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12 inputGroupContainer">
                                            <div class="input-group">
                                                <span class="input-group-addon"><i class="glyphicon glyphicon-align-justify
"></i></span>
                                                <a style="margin: 10px;" href="/media/pdf/{{$get_media_e_coverages_data->media_pdf}}" class="btn btn-primary">Media Pdf</a>
                                                <input class="form-control"  type="file" name="media_pdf" value="{{$get_media_e_coverages_data->media_pdf}}">
