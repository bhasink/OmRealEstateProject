            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        {!! Form::open(array('action'=>'Admin\AdminMediaController@media_press_releases_create_save','method'=>'post','id'=>'contact_formm','enctype' => 'multipart/form-data')) !!}
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-8 mb-3">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <a href="{{url('/omaxeadmin/media/list/press-releases')}}" class="btn btn-primary"  style="padding: 10px;  margin-top: 20px;">Go Back</a>
