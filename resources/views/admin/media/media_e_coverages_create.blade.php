            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        {!! Form::open(array('action'=>'Admin\AdminMediaController@media_e_coverages_create_save','method'=>'post','id'=>'contact_formm','enctype' => 'multipart/form-data')) !!}
...
"></i></span>
                                                ...
                                                <input required class="form-control"  type="text" name="media_e_coverages" >
