...
<div style="margin:0px">
        ...
        <tbody><tr>
            <td>
                <table border="0"  cellspacing="1" cellpadding="5" align="center" style="padding:10px;">
                    ...
                    <tr>
                        <td colspan="2" style="    font-weight: bolder; font-size: 18px;text-align:center;color:#ffffff;height:8px">Enuuiry Now Contact Us</td>
                    </tr>
                    <tr>
    ...
    text-decoration: none;">
                    ...
                    <tr>
                        ...
                        <td style="padding-left:20px;font-family:Arial;font-size:14px;color:#ffffff;">
                            @if(isset($data->user_residential_type))

                                {{$data->user_residential_type}}
