...
<div style="margin:0px">
        ...
        <tbody><tr>
            <td>
                <table border="0"  cellspacing="1" cellpadding="5" align="center" style="padding:10px;">
                    ...
                    <tr>
                        <td colspan="2" style="    font-weight: bolder; font-size: 18px;text-align:center;color:#ffffff;height:8px">Project Contact Us</td>
                    </tr>

                    <tr>
                        <td style="font-weight:bolder;padding-left:20px;font-family:Arial;font-size:14px;color:#ffffff;">Project name:</td>
    ...
    text-decoration: none;">
                    ...
                    <tr>
                        <td style="font-weight:bolder;padding-left:20px;font-family:Arial;font-size:14px;color:#ffffff;">Residential Type:</td>
                        <td style="padding-left:20px;font-family:Arial;font-size:14px;color:#ffffff;">
                            @if(isset($data["residential_type"]))
                    ...
                    <tr>
                        <td style="font-weight:bolder;padding-left:20px;font-family:Arial;font-size:14px;color:#ffffff;">Interested in visit site:</td>
                        <td style="padding-left:20px;font-family:Arial;font-size:14px;color:#ffffff;">
                            @if(isset($data["interested_visit_site"]))

                                {{$data["interested_visit_site"]}}
