@foreach($data['trending_properties'] as $index=>$trending_property)
        ...
        <div class="video">
            <div class="card" style="width: 100%;">
                <a  class="stamp-sm-container" href="{{URL::to('/projects/'.strtolower(str_replace(" ","-",$trending_property->project_city->name)).'/'.$trending_property->project_type->name.'/'.$trending_property->project_slug)}}">
                    ...
                    @elseif($trending_property->project_stamp_id == 12)
                    ...
                    @elseif($trending_property->project_stamp_id == 13)
                    ...
                    @elseif($trending_property->project_stamp_id == 14)
    ...
    {{--height: 47px;--}}
    {{--overflow: hidden;">--}}
                        {{--                                                                            {{ \Illuminate\Support\Str::words($trending_property->project_description,8)}}--}}
                        {{--{!! substr($trending_property->project_description, 0, 50) !!} ...--}}
                    {{--</p>--}}
