...
@section('content')
    ...
    <div class="project-page">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-3">
                    <div id="fcon" class="filter-container">
                        ...
                        <div class="filter-cont rpt">
                            ...
                            <div class="content residential-prop">
                                ...
                                <div class="checkbox-container">
                                    ...
                                    <label for="bhk-{{$value->slug}}">{{$value->property_type}}</label>
                                </div>
                                @endforeach
                            </div>
                        </div>
    ...
    {{--line-height: 1.7em;">--}}
                                    ...
                                    <div class="container" style="display:none;" id="commericial">
    ...
    {{--line-height: 1.7em;">--}}
                                    ...
                                    <?php if(count($data['project_details']) || count($data_all['allProjects'])) { ?>
                                    <div class="col-md-12 text-center view-all-btn">
                                        <button type="button" style="display: none;"  class="btn btn-outline-dark" id="loadresi" onclick="return ApplyFilters(true, 1, 99);">Load More</button>
                                    </div>
                                    <?php } ?>
    ...
    <script>
        ...
        var ApplyFilters = function(page, ptype, static){
            var city = Array();
            var projectType = Array();
//            var project_ids = ["486","487","496","537","432","430","428","511","453","541","530","517","476","474","481"];
