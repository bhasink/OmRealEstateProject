    ...
    bottom: -5px;">
        ...
        <header>
            <nav id='cssmenu'>
                ...
                <ul>
                    ...
                    <li class="active"><a href="{{URL::to('/projects/'.strtolower(str_replace(" ","-",$data['project_details']->project_city->name)).'/'.$data['project_details']->project_type->name.'/'.$data['project_details']->project_slug.'/'.'contact-us')}}">CONTACT US</a></li>
        ...
        <div class="container-fluid" style="margin-bottom: 80px;">
            <div class="main-content-heading" style="margin-top:50px; margin-bottom: 50px;">
                ...
                <p style="text-align: center; font-size:14px;line-height: 1.7em; margin: 10px 0; font-weight: 400;">Please fill in the following details. We will get back to you shortly.</p>
            </div>
                ...
                <div class="container formcon">
                    ...
                    <div class="col-md-12" style="margin-top:20px;">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-group">
                                    <label class="col-md-12 control-label"><b>Interested in visit site</b></label>
                                    <div class="col-md-12 selectContainer">
                                        <div class="input-group">
                                            <span class="input-group-addon"><i class="glyphicon glyphicon-list"></i></span>
                                            <select name="interested_visit_site" class="form-control {{ $errors->has('interested_visit_site') ? 'has-error' : '' }} selectpicker"     >
                                                <option value=" " >-Interested in visit site-</option>
                                                <option >Yes</option>
                                                <option>No</option>
                                            </select>
                                        </div>
                                        <span class="text-danger">{{ $errors->first('interested_visit_site') }}</span>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12 inputGroupContainer">
                                        <div class="input-group">
                                            ...
                                            <input type="tel" id="demo"  name="phone" placeholder="+91" class="form-control {{ $errors->has('phone') ? 'has-error' : '' }}" value="{{ old('phone') }}"  type="text">
                                        </div>
