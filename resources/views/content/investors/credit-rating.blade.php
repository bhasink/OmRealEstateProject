...
@section('content')
    ...
    <header>
        <nav id='cssmenu'>
            ...
            <ul>
                <li><a href='/investor/stakeholder-information'>STAKEHOLDER'S INFORMATION</a></li>
                ...
                <li><a href='/investor/stakeholder-information/notice-payment-redemption'>Notice(s) for the Date of Interest Payment/Redemption

                    </a></li>
                <li class="active"><a href='/investor/stakeholder-information/credit-rating'>CREDIT RATING(S)</a></li>
    ...
    {{--{{ Breadcrumbs::render('stakeholderd', "/about-us/awards-and-honors","Credit Rating") }}--}}
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Credit Rating</li>
    ...
    var applyYear = function(){
        ...
        var url = "{{url('/investor/stakeholder-information/credit-rating')}}";
        if(year == 0){
