...
@section('content')
    ...
    <div class="top-content financials">
    ...
    <header>
        <nav id='cssmenu'>
            ...
            <ul>
                <li class="active"><a href='/investor/financials'>FINANCIALS</a></li>
    ...
    {{--{{ Breadcrumbs::render('investors', "/about-us/awards-and-honors","Financials") }}--}}
    ...
    var applyYear = function(u){
		...
		if(typeof(u) === 'undefined'){
			var url = "{{url('/investor/financials')}}" + "?year=" + year + "&qtr=" + qtr;
		}else{
