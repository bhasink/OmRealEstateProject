...
@section('content')
    ...
    <div class="top-content corporate-governance">
    ...
    <header>
        <nav id='cssmenu'>
            ...
            <ul>
                <li class='active'><a href='/investor/corporate-governance'>CORPORATE GOVERNANCE</a></li>
                ...
                <li><a href='/investor/corporate-governance/corporate-governance-reports'>CORPORATE GOVERNANCE REPORTS</a></li>
    ...
    {{--{{ Breadcrumbs::render('investors', "/about-us/awards-and-honors","Corporate Governance") }}--}}
    ...
    <section class="invcon">
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12">
                    <h4>THE COMPANY’S PHILOSOPHY ON CORPORATE GOVERNANCE</h4><br>
                    <p style="margin-bottom: 20px;">Transparency, integrity and ethical standards are foundations for the conduct of business at ‘Omaxe’. This translates into the philosophy on ‘Corporate Governance’ of the Company. At ‘Omaxe’ it is believed that adoption of best practices of Corporate Governance ensures long term relations with the investors and customers of the Company. Further, the Company firmly believes in good Corporate Governance and at ‘Omaxe’ Corporate Governance has been a high priority both in letter and in spirit. The Company believes that good Corporate Governance strengthens the investors’ trust and ensures a long-term partnership that helps in Company’s objectives. The company’s philosophy on Corporate Governance lays strong emphasis on transparency and accountability in the functioning of the Company and conduct of business and places due emphasis on regulatory compliances. The philosophy is manifested in its operations through exemplary standards of ethical behavior, both within the organization as well as in external relationships. The Company is committed to enhance shareholders value in the fair and transparent manner and has been in the forefront for bench marking itself with the best business practices globally.</p>
                </div>
            </div>
    ...
    var applyYear = function(){
        ...
        var url = "{{url('/investor/corporate-governance')}}";
        if(year == 0){
