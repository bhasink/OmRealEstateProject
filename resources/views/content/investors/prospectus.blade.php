...
@section('content')
    ...
    <header>
        <nav id='cssmenu'>
            ...
            <ul>
                ...
                <li class="active"><a href='/investor/annual-report/prospectus'>PROSPECTUS</a></li>
    ...
    {{--{{ Breadcrumbs::render('investorsabout', "/about-us/awards-and-honors","Prospectus") }}--}}
    ...
    var applyYear = function(){
        ...
        var url = "{{url('/investor/annual-report/prospectus')}}";
        if(year == 0){
