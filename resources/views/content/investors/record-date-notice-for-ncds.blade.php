...
@section('content')
    ...
    <header>
        <nav id='cssmenu'>
            ...
            <ul>
                ...
                <li class="active"><a href='/investor/stakeholder-information/record-date-notice-for-ncds'>RECORD DATE NOTICE FOR NCD(S)</a></li>
    ...
    {{--{{ Breadcrumbs::render('stakeholderd', "/about-us/awards-and-honors","Record Date Notice For Ncds") }}--}}
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Record Date Notice For NCDs</li>
    ...
    {{--var applyYear = function(){--}}
        ...
        {{--var url = "{{url('/investor/stakeholder-information/record-date-notice-for-ncds')}}";--}}
        {{--if(year == 0){--}}
