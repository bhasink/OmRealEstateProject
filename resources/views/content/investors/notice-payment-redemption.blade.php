...
@section('content')
    ...
    {{--{{ Breadcrumbs::render('stakeholderd', "/about-us/awards-and-honors","Notice Payment Redemption") }}--}}
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Notice Payment Redemption</li>
    ...
    {{--var applyYear = function(){--}}
        ...
        {{--var url = "{{url('/investor/stakeholder-information/notice-payment-redemption')}}";--}}
        {{--if(year == 0){--}}
