...
@section('content')
    ...
    <header>
        <nav id='cssmenu'>
            ...
            <ul>
                ...
                <li><a href='/investor/stakeholder-information/credit-rating'>CREDIT RATING</a></li>
                <li class="active"><a href='/investor/stakeholder-information/notice-and-information'>NOTICE(S) AND INTIMATION(S)</a></li>
    ...
    {{--{{ Breadcrumbs::render('stakeholderd', "/about-us/awards-and-honors","Notice And Intimation") }}--}}
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Notice And Intimation</li>
    </ol>
    ...
    {{--var applyYear = function(){--}}
        ...
        {{--var url = "{{url('/investor/stakeholder-information/notice-and-information')}}";--}}
        {{--if(year == 0){--}}
