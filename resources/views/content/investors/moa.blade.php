...
@section('content')
    ...
    <header>
        <nav id='cssmenu'>
            ...
            <ul>
                ...
                <li class="active"><a href='/investor/annual-report/moa-and-aoa'>MOA &AMP; AOA</a></li>
    ...
    {{--{{ Breadcrumbs::render('investorsabout', "/about-us/awards-and-honors","Moa And Aoa") }}--}}
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">MOA And AOA</li>
    ...
    var applyYear = function(){
        ...
        var url = "{{url('/investor/annual-report/moa-and-aoa')}}";
        if(year == 0){
