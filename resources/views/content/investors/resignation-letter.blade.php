...
@section('content')
    ...
    <header>
        <nav id='cssmenu'>
            ...
            <ul>
                ...
                <li class='active'><a href='/investor/corporate-governance/resignation-letters'>RESIGNATION LETTERS</a></li>
    ...
    {{--{{ Breadcrumbs::render('corporategov', "/about-us/awards-and-honors","Resignation Letters") }}--}}
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Resignation Letters</li>
    ...
    var applyYear = function(){
        ...
        var url = "{{url('/investor/corporate-governance/resignation-letters')}}";
        if(year == 0){
