...
@section('content')
    ...
    <style>
        .top-content{
            ...
            height: 515px;
            width: 100%;
            background: url({{cdn()}}/images/static/AnnualReports.jpg) no-repeat center;
        }
    ...
    <header>
        <nav id='cssmenu'>
            ...
            <ul>
                ...
                <li class="active"><a href='/investor/annual-report/certificate-incorporation'>CERTIFICATE OF INCORPORATIONS</a></li>
    ...
    {{--{{ Breadcrumbs::render('investorsabout', "/about-us/awards-and-honors","Certificate Incorporation") }}--}}
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Certificate of Incorporations</li>
    ...
    var applyYear = function(){
        ...
        var url = "{{url('/investor/annual-report/certificate-incorporation')}}";
        if(year == 0){
