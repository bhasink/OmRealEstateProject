...
@section('content')
    ...
    <header>
        <nav id='cssmenu'>
            ...
            <ul>
                ...
                <li class='active'><a href='/investor/corporate-governance/appointment-letters'>Appointment letter</a></li>
    ...
    {{--{{ Breadcrumbs::render('corporategov', "/about-us/awards-and-honors","Appointment Letters") }}--}}
    ...
    var applyYear = function(){
        ...
        var url = "{{url('/investor/corporate-governance/appointment-letters')}}";
        if(year == 0){
