...
@section('content')
    ...
    <header>
        <nav id='cssmenu'>
            ...
            <ul>
                <li><a href='/investor/csr/event'>CSR EVENTS</a></li>
                <li><a href='/investor/csr/policy'>CSR POLICY</a></li>
                <li class='active'><a href='/investor/csr/project'>CSR PROJECTS</a></li>
    ...
    {{--{{ Breadcrumbs::render('investors', "/about-us/awards-and-honors","Csr Projects") }}--}}
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">CSR Projects</li>
    ...
    var applyYear = function(){
        ...
        var url = "{{url('/investor/csr/project')}}";
        if(year == 0){
