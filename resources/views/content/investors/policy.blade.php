    ...
    <header>
        <nav id='cssmenu'>
            ...
            <ul>
                ...
                <li class='active'><a href='/investor/csr/policy'>CSR POLICY</a></li>
...
{{--    {{ Breadcrumbs::render('investors', "/about-us/awards-and-honors","Csr Policy") }}--}}
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">CSR Policy</li>
    ...
    var applyYear = function(){
        ...
        var url = "{{url('/investor/csr/policy')}}";
        if(year == 0){
