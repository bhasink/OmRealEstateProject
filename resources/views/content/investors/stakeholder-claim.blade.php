...
@section('content')
    ...
    <header>
        <nav id='cssmenu'>
            ...
            <ul>
                <li><a href='/investor/stakeholder-information'>STAKEHOLDERS INFORMATION</a></li>
                <li class="active"><a href='/investor/stakeholder-information/shareholder-claim'>SHAREHOLDER(S) CLAIM</a></li>
                <li><a href='/investor/stakeholder-information/notice-and-scrutinizers-report'>Notice, Results and Announcements</a></li>
                <li><a href='/investor/stakeholder-information/record-date-notice-for-ncds'>RECORD DATE NOTICE FOR NCD(S)</a></li>
    ...
    {{--{{ Breadcrumbs::render('stakeholderd', "/about-us/awards-and-honors","Stakeholder Claim") }}--}}
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Stakeholder Claim</li>
    ...
    <section class="invcon">
        <div class="container stakeholder" id="doc_container" style="margin-bottom: 100px;">
    ...
    {{--var applyYear = function(){--}}
        ...
        {{--var url = "{{url('/investor/stakeholder-information/stakeholder-claim')}}";--}}
        {{--if(year == 0){--}}
    ...
    <script>
        var applyYear = function(b){
            ...
            if(typeof(b) === 'undefined'){
                var url = "{{url('/investor/stakeholder-information/shareholder-claim')}}";
                url += "?year=" + year;
            }else{
                url = b + "&year=" + year;
            }
