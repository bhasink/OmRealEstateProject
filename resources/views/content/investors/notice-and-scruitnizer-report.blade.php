...
@section('content')
    ...
    <header>
        <nav id='cssmenu'>
            ...
            <ul>
                ...
                <li class="active"><a href='/investor/stakeholder-information/notice-and-scrutinizers-report'>NOTICE(s) AND SCRUTINIZER(S) REPORT</a></li>
    ...
    {{--{{ Breadcrumbs::render('stakeholderd', "/about-us/awards-and-honors","Notice And Scrutinizers Report") }}--}}
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Notice And Scrutinizers Report</li>
    ...
    var applyYear = function(){
        ...
        var url = "{{url('/investor/stakeholder-information/notice-and-scrutinizers-report')}}";
        if(year == 0){
