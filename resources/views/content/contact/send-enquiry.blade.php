    ...
    <header>
        <nav id='cssmenu'>
            ...
            <ul>
                ...
                <li><a href='/contact-us/regional-offices'>REACH US</a></li>
                <li class="active"><a href='/contact-us/send-enquiry'>SEND ENQUIRY</a></li>
            </ul>

        </nav>
    </header>

{{--    {{ Breadcrumbs::render('investors', "/about-us/awards-and-honors","Send Enquiry") }}--}}
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Send Enquiry</li>
    ...
    <section class="invcon">
        ...
        <div class="container formcon">
            <div class="main-content-heading" style="margin-bottom: 50px;">
                <h1 style="    color: #0262b5;text-align: center;text-transform: uppercase;    letter-spacing: 1px;  font-weight: 300 !important; ">CONTACT US</h1>
                <p style="text-align: center; font-size:14px;letter-spacing: 1px; font-weight: 400;">
                    Call : +91-9015161718 (10 am to 6 pm IST)
                    <br>
                    SMS : OMAXE to 56677
                </p>
            </div>
            <div class="col-md-12" style="margin-top:20px;">
                ...
                {{--{!! Form::open(array('action' => 'ProjectController@contact_us_project', 'method' => 'post','id'=>'contact_formm','enctype' => 'multipart/form-data')) !!}--}}

                {{--<form class="" action=" " method="post"  id="contact_formm">--}}

                {!! Form::open(array('action' => 'MainController@common_contact_us', 'method' => 'post','id'=>'contact_formm','enctype' => 'multipart/form-data')) !!}
                ...
                <div class="form-row">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12 selectContainer">
                                    <div class="input-group">
                                        ...
                                        <select id="country" name="country" class="form-control {{ $errors->has('country') ? 'has-error' : '' }} selectpicker"  >
                        ...
                        {{--<div class="col-md-6 mb-3">--}}
                            {{--<div class="form-group">--}}
                                ...
                                {{--<div class="col-md-12 inputGroupContainer">--}}
                                    {{--<div class="input-group">--}}
                                        {{--<span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>--}}
                                        {{--<input  name="project_name" placeholder="Project Name" class="form-control {{ $errors->has('name') ? 'has-error' : '' }}" value="{{ old('name') }}"  type="text">--}}
                    ...
                    <div class="form-row">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12 inputGroupContainer">
                                    <div class="input-group">
                                        ...
                                        <textarea class="form-control {{ $errors->has('address') ? 'has-error' : '' }}" rows="3" name="address"  value="{{ old('address') }}" placeholder="Address"></textarea>
                                    </div>
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-group">
                                <label class="col-md-12 control-label"><b>Query</b></label>
                                <div class="col-md-12 inputGroupContainer">
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="glyphicon glyphicon-pencil"></i></span>
                                        <textarea class="form-control {{ $errors->has('project_query') ? 'has-error' : '' }}" rows="3"  value="{{ old('project_query') }}"  name="project_query" placeholder="Query"></textarea>
                                    </div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-group" style="float:left;">
                                ...
                                <div class="col-md-12">
                                    <button type="submit" style="padding: 10px; padding-left: 80px; padding-right: 80px; margin-top: 20px;" class="btn btn-primary" >Submit <span class="glyphicon glyphicon-send"></span></button>
                                </div>
                            </div>
                        </div>
    ...
    <script>
        ...
        //         $ajax({
        //             type:  "GET",
        //             URL: "http://battuta.medunes.net/api/city/jp/search/?city=paris&callback=?&key={0af5a48936c8309b1d5e951e8c25403a},
        //             data : "country_selectedvalue="+$(this).val(),
        //             async: false,
