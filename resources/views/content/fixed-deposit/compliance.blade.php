...
<section class="downloads">
    <div class="container">
        <div class="row download-block">
            <div class="col-6">
                <p><i class="fa fa-file"></i>&nbsp;&nbsp;DPT1</p>
            </div>

            <div class="col-6">
                <p><a target="_blank"  href="/fd/img/DPT-1.pdf"><i class="fa fa-download"></i>&nbsp;&nbsp; Downloads</a></p>
            </div>

        </div>
        <div class="row download-block">
            <div class="col-6">
                <p><i class="fa fa-file"></i>&nbsp;&nbsp;DPT-1 Hindi Business Standard 6.9.18</p>
            </div>

            <div class="col-6">
                <p><a target="_blank"  href="/fd/img/DPT-1 Hindi Business Standard 6.9.18.pdf"><i class="fa fa-download"></i>&nbsp;&nbsp; Downloads</a></p>
            </div>

        </div>
        <div class="row download-block">
            <div class="col-6">
                <p><i class="fa fa-file"></i>&nbsp;&nbsp;DPT-1 English Business Standard 6.9.18</p>
            </div>

            <div class="col-6">
                <p><a target="_blank"  href="/fd/img/DPT-1 English Business Standard 6.9.18.pdf"><i class="fa fa-download"></i>&nbsp;&nbsp; Downloads</a></p>
            </div>
