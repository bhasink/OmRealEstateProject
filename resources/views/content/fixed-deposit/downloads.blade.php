...
<section class="downloads">
    <div class="container">
        <div class="row download-block">
            <div class="col-6">
                <p><i class="fa fa-file"></i>&nbsp;&nbsp;Application Form</p>
            </div>

              <div class="col-6">
                <p><a target="_blank" href="/fixed-deposit/fd-application-form"><i class="fa fa-download"></i>&nbsp;&nbsp; Downloads</a></p>
            </div>
        ...
        <div class="row download-block">
            <div class="col-6">
                <p><i class="fa fa-file"></i>&nbsp;&nbsp;Form15G</p>
            </div>

            <div class="col-6">
                <p><a target="_blank" href="/fd/download/Form15G.pdf"><i class="fa fa-download"></i>&nbsp;&nbsp; Downloads</a></p>
            </div>
        ...
        <div class="row download-block">
            <div class="col-6">
                <p><i class="fa fa-file"></i>&nbsp;&nbsp;Form15H</p>
            </div>

            <div class="col-6">
                <p><a target="_blank" href="/fd/download/Form15H.pdf"><i class="fa fa-download"></i>&nbsp;&nbsp; Downloads</a></p>
            </div>
        ...
        <div class="row download-block">
            <div class="col-6">
                <p><i class="fa fa-file"></i>&nbsp;&nbsp;Change Request Form</p>
            </div>

            <div class="col-6">
                <p><a target="_blank" href="/fd/download/Change-Request-Form.Pdf"><i class="fa fa-download"></i>&nbsp;&nbsp; Downloads</a></p>
            </div>
