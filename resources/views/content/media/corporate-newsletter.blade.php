...
@section('content')
    ...
    {{--{{ Breadcrumbs::render('investors', "/about-us/awards-and-honors","Corporate Newsletter") }}--}}
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Corporate Newsletter</li>
    ...
    <script>
        var applyYear = function(){
            ...
            var url = "{{url('/media/corporate-newsletter')}}";
            if(year == 0){
