...
@section('content')
    ...
    <div class="top-content events-banner">
    ...
    <header>
        <nav id='cssmenu'>
            ...
            <ul>
                ...
                <li class='active'><a href='/media/events'>EVENTS</a></li>
...
{{--    {{ Breadcrumbs::render('investors', "/about-us/awards-and-honors","Events") }}--}}
        ...
        {{--$(document).ready(function() {--}}
            {{--$('#event').on('click', function () {--}}
                {{--$(this).lightGallery({--}}
                    {{--dynamic: true,--}}
                    {{--dynamicEl: [{--}}
                        {{--"src": '{{cdn()}}/media/images/{{$ad_campaigns->media_image}}',--}}
                        {{--'thumb': '{{cdn()}}/media/images/{{$ad_campaigns->media_image}}'--}}
                    {{--}]--}}
                {{--})--}}
            ...
            {{--$.get(url, function(data, status){--}}
                {{--if(status == "success"){--}}
                    ...
                    {{--for(var i=0; i < data.length; i++){--}}
                        ...
                        {{--temp +=    "<figure><div>";--}}
                        {{--temp +=    "<img src='{{cdn()}}/media/images/" + data[i].media_image +"' height='200' width='100%' alt=''></div> <figcaption class='repdata'> <div class='row'> <div class='col-9'>";--}}
    ...
    <script>
        ...
        var applyYear = function(u){
            ...
            if(typeof(u) === 'undefined'){
                var url = "{{url('/media/events')}}" + "?year=" + year + "&qtr=" + qtr;
            }else{
