...
@section('content')
    ...
    <div class="top-content e-coverage-banner">
    ...
    <header>
        <nav id='cssmenu'>
            ...
            <ul>
                ...
                <li class='active'><a href='/media/e-coverages'>E-COVERAGES</a></li>
...
{{--    {{ Breadcrumbs::render('investors', "/about-us/awards-and-honors","E-coverage") }}--}}
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">E-Coverages</li>
    ...
    {{--var temp = "  <div class='col-md-3 rep'><figure>";--}}
            {{--temp +=    "<a target='_blank' href='"+data[i].e_coverage_links+'>";--}}
                {{--temp +=    "<img  src='{{cdn()}}/media/images/"+data[i].media_image+"' height='200' width='100%' alt=''>";--}}
                {{--temp += " <div class='repdata e-description'> <div class='row'> <div class='col-md-12'><h4>"+data[i].media_title+"</h4>";--}}
                            {{--temp += "<p>"+data[i].report_year+"</p>";--}}
                            {{--temp += " </div></div> </div> </a> </figure> </div>";--}}
    {{--contains += temp;--}}
    ...
    <script>
        ...
        var applyYear = function(u){
            ...
            if(typeof(u) === 'undefined'){
                var url = "{{url('/media/e-coverages')}}" + "?year=" + year + "&qtr=" + qtr;
            }else{
